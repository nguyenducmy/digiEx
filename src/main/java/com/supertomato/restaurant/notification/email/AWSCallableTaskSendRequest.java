...
public class AWSCallableTaskSendRequest implements Callable<String> {
    ...
    private ApplicationValueConfigure applicationValueConfigure;

    public AWSCallableTaskSendRequest(ApplicationValueConfigure applicationValueConfigure, String[] to, String subject, String body, String attachment, String senderName) {
